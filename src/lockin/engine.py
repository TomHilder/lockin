    ...
    def _load_state(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if state_value not in valid_states:
                print(
                    f"Warning: Invalid session_state '{state_value}', resetting to idle"
                )
            ...
            if saved_state.get("session_type") not in [
                None,
                SessionType.WORK,
                SessionType.BREAK,
                "work",
                ...
                print(
                    f"Warning: Invalid session_type '{saved_state.get('session_type')}', resetting to idle"
                )
                saved_state["session_state"] = SessionState.IDLE
                saved_state["session_type"] = None
